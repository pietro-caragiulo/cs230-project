...
def main(unused_argv):
  ...
  inFile = "combined_02mm"
  outFile = "combined_02mm_00000316"
  dataDir = "../datasets/02mm"
  nEvents = 131072
  ...
  decay_rate = 0.95
  batch_size = nEvents
  sparsity_loss_weight = 0.00000316
  ...
  # Training setup
  model_name = "tabnet_forest_covertype_model_" + outFile
  ...
  with tf.Session() as sess:
    ...
    for step in range(1, max_steps + 1):
      ...
      if(step == max_steps):
        with open("./tflog/" + model_name + '/' + outFile + '_out.csv', mode='w') as output_file:
